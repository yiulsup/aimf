...
class AiMF_NPU():
    ...
    def post_draw(self, img, classes, scores, boxes, model_input_height, model_input_width):
        ...
        for i, c in enumerate(classes):
            ...
            cv2.putText(img, label, (left, top-2), font_face, font_scale, (0,0,0), font_thick, cv2.LINE_AA)
    ...
    def work(self):
        while True:
            ...
            grayImage = cv2.resize(grayImage, (416, 416))
            ...
            detected_image = self.post_draw(grayImage, classes, scores, boxes, 416, 416)
